...
const Card = ({ name, imageLink, pdfLink, price, DiscPrice, Description, slug, id }: ProjectData) => {
        ...
        <div className="lg:w-11/12 lg:mx-auto mx-0 lg:px-4 px-2 py-6 lg:py-12">
            <div className="grid md:grid-cols-12 gap-y-4 lg:gap-12">
                ...
                <div className="lg:space-y-6 col-span-5 space-y-2 sticky md:top-24 self-start">
                    ...
                    <div className="flex gap-4">
                        <Button className="w-full h-12 text-lg bg-blue-600 hover:bg-blue-700 text-white" onClick={handleAddToCart}>
            ...
            <div className="mt-8">
                <div className="flex justify-between">
                    ...
                    <Button>
                        <Link href={`/projects/${slug}`}>View All</Link>
                    </Button>
                </div>
                <div className="w-full">
                    {/* Similar project cards */}
                    <MoreProject category={slug} projects_slug={id} />
                </div>
            </div>
        </div>
    );
