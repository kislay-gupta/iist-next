  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-b from-gray-50 to-white">
      <div className="w-full max-w-4xl">
        <Link href="/" className="bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-900 px-4 py-2 rounded-lg mb-6 inline-flex items-center gap-2 transition-all">
          <span>←</span>
