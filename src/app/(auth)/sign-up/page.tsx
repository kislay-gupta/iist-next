    ...
    <>
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="w-full max-w-5xl">
          <Link
            href="/"
            className="bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-900 px-4 py-2 rounded-lg mb-6 inline-flex items-center gap-2 transition-all"
          >
            <span>←</span>
          ...
          <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="flex flex-col items-center text-center space-y-2">
                      <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                        Welcome To IIST Bihar
                      </h1>
                      <p className="text-balance text-gray-500">
                        Sign up to your IIST Bihar account
                      </p>
                    </div>
                    <SignUpForm />
            ...
            <div className="text-balance text-center text-xs text-gray-500 [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-gray-900">
